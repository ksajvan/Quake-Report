...
public final class QueryUtils {
    ...
    public static ArrayList<Earthquake> extractEarthquakes() {
        ...
        ArrayList<Earthquake> earthquakesInfo = new ArrayList<>();
        ...
        try {
            ...
            for (int i = 0; i < features.length(); i++) {
                ...
                JSONObject property = jsonObject.getJSONObject("properties");
//                String magnitude = property.optString("mag").toString();
                double magnitude = property.getDouble("mag");
                String place = property.optString("place").toString();
                ...
                // extract the value for the 'url' key
                String url = property.getString("url");

                earthquakesInfo.add(new Earthquake(magnitude, place, time, url));
            }
